...
export const guides: GuideEntry[] = [
  {
    ...
    body: [
      ...
      "Also available on Android as Endings Guide for Elden Ring. It's an unofficial fan-made companion, not affiliated with or endorsed by FromSoftware or Bandai Namco.",
    ],
  },
];
